...
extension L {
    ...
    var releaseNotes: [ReleaseNote] {
        [
            ReleaseNote(version: "0.8.0", items: [
                ReleaseNoteItem(text: t("도감 개편 — 모든 팩에 도감이 생겼습니다",
                                         "Dex overhaul — every pack now has one",
                                         "図鑑改編 — すべてのパックに図鑑がつきました",
                                         "Dex renovado: ahora cada sobre tiene uno",
                                         "Dex refondu — chaque booster a le sien",
                                         "Dex reformulado — cada pacote tem o seu"), details: [
                    t("조합 도감 155종 · 전체 277종 추가",
                      "155 theme dexes added, 277 in all",
                      "テーマ図鑑155種 · 全体277種を追加",
                      "155 dex temáticos añadidos, 277 en total",
                      "155 dex thématiques ajoutés, 277 en tout",
                      "155 dex temáticos adicionados, 277 no total"),
                ]),
                ReleaseNoteItem(text: t("도감 보상 개편",
                                         "Dex rewards reworked",
                                         "図鑑報酬を改編",
                                         "Recompensas del dex renovadas",
                                         "Récompenses du dex revues",
                                         "Recompensas do dex reformuladas"), details: [
                    t("신규 보상: 누적 혜택 · 팩 · 팩 할인 쿠폰 · 확정 카드",
                      "New rewards: perks, packs, pack coupons and a granted card",
                      "新しい報酬: 永続効果 · パック · 割引クーポン · 確定カード",
                      "Nuevas recompensas: ventajas, sobres, cupones y carta garantizada",
                      "Nouvelles récompenses : avantages, boosters, coupons et carte garantie",
                      "Novas recompensas: vantagens, pacotes, cupons e carta garantida"),
                ]),
                ReleaseNoteItem(text: t("한도 달성 보너스 팩 조정",
                                         "Limit bonus packs rebalanced",
                                         "上限達成ボーナスパックを調整",
                                         "Sobres por límite reajustados",
                                         "Boosters bonus de quota réajustés",
                                         "Pacotes bônus de limite reajustados"), details: [
                    t("무작위 세트 10팩 → 세트에 따라 1~7팩",
                      "Ten random packs became one to seven, depending on the set",
                      "無作為のセット10パック → セットにより1~7パック",
                      "Diez sobres al azar pasan a ser de 1 a 7 según el set",
                      "Dix boosters au hasard deviennent 1 à 7 selon le set",
                      "Dez pacotes aleatórios viram de 1 a 7 conforme o set"),
                    t("세트마다 팩값이 크게 달라 보상이 튀던 것을 고정",
                      "Pack prices vary hugely between sets, so the payout no longer swings",
                      "セットごとにパック価格が大きく違い、報酬が跳ねていたのを固定",
                      "Los precios varían mucho entre sets; el premio ya no salta",
                      "Les prix varient beaucoup selon les sets ; le gain ne saute plus",
                      "Os preços variam muito entre sets; o prêmio não oscila mais"),
                ]),
                ReleaseNoteItem(text: t("버그 수정",
                                         ...
                                         "Corrections",
                                         "Correções"), details: [
                    t("계정을 바꾸면 같은 한도에서 보너스 팩이 다시 지급되던 현상 수정",
                      "Switching accounts could pay bonus packs again for the same limit window",
                      "アカウントを切り替えると同じ上限枠でボーナスパックが再支給される問題を修正",
                      "Cambiar de cuenta podía repetir los sobres de la misma ventana",
                      "Changer de compte pouvait redonner les boosters de la même fenêtre",
                      "Trocar de conta podia repetir os pacotes da mesma janela"),
                ]),
            ]),
